...
struct {
  ...
  {"FLOAT", KW_FLOAT},    // GK1: Thêm 2 keyword mới vào bảng keyword
  {"ARRAY", KW_ARRAY},
  {"OF", KW_OF},
...
char *tokenToString(TokenType tokenType) {
  ...
  case TK_FLOAT: return "a float number";   // GK1: Bổ sung case cho 4 Token vừa thêm vào
  ...
  case KW_FLOAT: return "keyword FLOAT";    // GK1: Bổ sung case cho 4 Token vừa thêm vào
