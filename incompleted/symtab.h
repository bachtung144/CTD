...
enum TypeClass {
  ...
  TP_FLOAT        // GK1: Thêm vào 2 TypeClass cho 2 kiêu dữ liệu mới
};
...
struct ConstantValue_ {
  ...
  union {
    ...
    float floatValue;   // GK1: Lưu constantValue kiểu float
  };
};
...
Type* makeFloatType(void);     // GK1: Bổ sung thêm 2 hàm mới vào file symtab.c
...
ConstantValue* makeFloatConstant(float d);    // GK1: Bổ sung thêm hàm makeFloat
