...
struct ErrorMessage errors[31] = {
  ...
  {ERR_UNDECLARED_INT_CONSTANT, "Undeclared integer constant or float constant."},   // GK1 : Sửa lại lỗi định nghĩa
  ...
  {ERR_INVALID_FLOAT, "A float number excepted."},   // GK1: Them truong hợp float lỗi.
